...
ind_choices <- c("Balanza Comercial" = "1",
                 ...
                 "GIS - Datos por Accion (MXN)" = "52",
                 "GIS - Datos por Accion (USD)" = "53",
                 "GIS - Multiplos" = "54",
                 "GIS - Edo Fin Acum (MXN)" = "55",
                 "GIS - Edo Fin Acum (USD)" = "56",
                 "GIS - Trim (MXN)" = "57",
                 "GIS - Trim (USD)" = "58",
                 "GIS - UDM (MXN)" = "59",
                 "GIS - UDM (USD)" = "60",
                 "GIS - Razones Fin (MXN)" = "61",
                 "GIS - Razones Fin (USD)" = "62"
                 )
